# maczo Originals — Cross the Road · Provably Fair

Welcome. This wiki explains how every **Cross the Road** result on [maczo.co](https://maczo.co) is provably
...
- 🔐 **[The Algorithm](Algorithm)** — the HMAC-SHA256 → uint32 engine + Cross the Road's resolve step
...
- **Live (offline in your browser):** https://verify.maczo.co/originals/?game=crossroad
- **Source / Node CLI:** https://github.com/maczo-co/originals-crossroad
- **Published odds:** https://verify.maczo.co/originals/paytables/crossroad.json
