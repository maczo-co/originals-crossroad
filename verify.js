// originals-crossroad — verifier CLI for the "Cross the Road" Original.
//
...
// server-side Python (libs/game_math/crossroad.py). Green = the JS matches the server bit-for-bit.
//
